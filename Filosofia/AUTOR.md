...
- **O material é a REFERÊNCIA DO ALUNO — a explicação é do professor.** Prosa curta para o raciocínio, marcadores para o que é enumerável: máximo 2 frases seguidas antes de uma lista; tabela sempre que houver 2+ posições a contrastar.
...
- **Extensão: alvo 220–250 palavras, teto firme de 300** por aula (tabelas e boxes fora da conta) — **direto e conciso é o padrão da casa**. Desenvolva todo o recorte e pare: sem exemplos extras, sem parágrafos de contexto para "engordar". Se passar de 300, corte rodeio e redundância — nunca recorte do blueprint. Aula que cobriu todo o recorte de forma direta em 200 palavras está pronta; **não trate o teto como meta**.
...
- **Tabela comparativa** sempre que houver 2 ou mais posições a contrastar (racionalismo × empirismo, correntes éticas) — é o formato que mais economiza texto.
...
4. **Ritmo:** questão → tese → argumento → objeção. Abertura de seção em 1 frase direta; parágrafos de no máximo 2–3 frases; cada frase entrega informação.
...
- [ ] Cada aula abre com dilema/situação concreta ou fato direto · 220–250 palavras (teto 300) · autossuficiente
