# PADRÕES DE ESCRITA — Nível de profundidade × Nível do aluno

> **O que é:** referência única, para **todas as disciplinas do projeto** (13 do 6º ano em diante + Matemática EF1), de como escrever cada aula no nível certo — combinando o **nível de profundidade do conteúdo** (N1–N4, marcado em cada aula do blueprint) com o **nível do aluno** (faixa/série).
>
> **Como usar:** este arquivo acompanha o prompt de produção (subir no projeto junto com o arquivo de aulas e os blueprints, ou colar como seção do prompt). A divisão de papéis é: o **blueprint** diz *o quê* e *até onde* (recorte da aula + nível N + NÃO ANTECIPAR); **este arquivo** diz *como escrever* naquele nível para aquela série.
>
> **Origem da escala:** vocabulário de profundidade do pipeline de frameworks (skill `framework-unidade`), adaptado aqui do capítulo para a **aula de ~50 min**.
...
> Absorvido do antigo `_MODELO-DE-CAPITULO.md` em 21/07/2026. **Enquanto os capítulos-modelo por disciplina não existirem, esta seção é a âncora de formato:** capítulo que sair diferente disto está errado. Capítulo-modelo real já aprovado: `Portugues/portugues-6ano-3bim-cap1-completo.md`.
...
> Dois bolos iguais: em um você comeu 1 pedaço de 2; no outro, 2 pedaços de 4. Você comeu a mesma quantidade nos dois?
...
> 💡 **Você sabia?**  
> {1 frase única — dado isolado, nunca mini-parágrafo.}
