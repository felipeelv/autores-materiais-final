...
| Ano | Arquivo | Situação |
|---|---|---|
| 4º ano | `estudos-sociais-4ano-modelo.md` | Disponível para validação |
| 5º ano | `estudos-sociais-5ano-modelo.md` | Disponível para validação |
| 6º ano | `estudos-sociais-6ano-modelo.md` | Disponível para validação |
| 7º ano | `estudos-sociais-7ano-modelo.md` | Disponível para validação |
